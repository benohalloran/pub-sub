...
client_transport = Thrift::BufferedTransport.new(Thrift::Socket.new(client_host, client_port))
client = Concord::PubSub::PubSubConsumer::Client.new(Thrift::BinaryProtocol.new(client_transport))

client_transport.open
client.receive "auwsome topic", "auwsome msg"
